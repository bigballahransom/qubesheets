          ...
          {otherFields.map((field) => (
            <div key={field.fieldId}>
              ...
              <input
                ...
                onClick={(e) => {
                  if (field.fieldId === 'moveDate') {
                    (e.target as HTMLInputElement).showPicker();
                  }
                }}
                className={`w-full px-4 py-3 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent${field.fieldId === 'moveDate' ? ' cursor-pointer' : ''}`}
