...
async function connectMongoDB() {
  ...
  if (!cached.promise) {
    const opts = {
      ...
      maxPoolSize: parseInt(process.env.MONGODB_MAX_POOL_SIZE) || 3, // EMERGENCY: Further reduced to 3 to prevent bulk upload leaks
      minPoolSize: 1, // EMERGENCY: Reduced from 2 to 1
      maxIdleTimeMS: 5000, // EMERGENCY: Reduced from 10s to 5s for faster cleanup
